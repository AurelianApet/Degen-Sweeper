  ...
  return (
    <div className='stakingpage'>
      ...
      <div className='row stakingpageFirstSection'>
        ...
        <div className='col-xl-4'>
          <StakingStats stakedNfts={stakedNfts.length} totalStaked={totalStaked} claimAmount={((claimAmount ? parseFloat(claimAmount) : parseFloat('0.00')) + extraReward).toFixed(2)} dailyRewardAmount={dailyRewardAmount} floorPrice={floorPrice} />
        </div>
      </div>
